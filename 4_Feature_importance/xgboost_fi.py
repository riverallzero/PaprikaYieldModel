...
def main():
    ...
    # # 1. 환경, 생육 데이터
    # plt.bar(labels, dataset1["Environment"], label='Environment', color="orange")
    # plt.bar(labels, dataset1["Growth"], bottom=dataset1["Environment"], label='Growth', color="yellowgreen")
    # plt.legend(loc="lower right")
    # plt.title("XGBoost")
    # plt.tight_layout()
    # plt.savefig("XGBoost_feature1.png", dpi=600)
    ...
    # plt.tight_layout()
    # plt.savefig("XGBoost_feature2.png", dpi=600)
    # plt.show()
